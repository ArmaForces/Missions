...
/*
 * Author: 3Mydlo3
 * Function returns nearest map city which has available name for given position/unit.
 *
 * Arguments:
 ...
 *
 * Example:
 * [player] call afsk_common_fnc_getNearestCityWithAvailableName
 *
 * Public: No
 */
...
private _locations = nearestLocations [_pos, ["NameVillage", "NameCity", "NameCityCapital"], _searchRadius];

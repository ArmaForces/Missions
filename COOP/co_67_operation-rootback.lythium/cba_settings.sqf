// AI
force AF_grenadeSpam = 30;
force AF_RPG_spam = 80;

// Mission Settings
force AF_respawn_tickets = -1
force AF_respawnCamType = 1;

// Advanced mission settings
force AF_hardcoreDamageEnabled = false;
force AF_friendlyTrackerShowUnconc = true;
force AF_friendlyTrackerGPS = true;

// ACE Advanced Fatigue
force ace_advanced_fatigue_enabled = true;
ace_advanced_fatigue_enableStaminaBar = true;
force ace_advanced_fatigue_loadFactor = 1.4;
...
// ACE Ogranicznik zasiÄ™gu widzenia
...
force ace_hearing_earplugsVolume = 0.9;
...
// ACEX Ograniczenie widocznoĹ›ci
...
Achilles_var_AF_FR = true;
Achilles_var_AF_LT = true;
...
Achilles_var_Custom_Faction = true;
Achilles_var_FFAA = true;
...
Achilles_var_KA_Land_Warrior = true;
...
force acre_sys_core_ts3ChannelName = "Gramy";
...
force AGC_bodyType = "body";
force AGC_checkTimes = 100;
force AGC_GCenabled = true;
force AGC_GCmaxBodyTime = 1200;
force AGC_GCmaxDistance = 1000;
force AGC_GCmaxTime = 900;
force AGC_GCminDistance = 60;
force AGC_GCminTime = 30;
force AGC_GCrefreshInterval = 0;
force AGC_GCvehicleCleanupDistance = 10;
force AGC_maxBodyHandle = 0;
force AGC_ragdoll = true;
force AGC_removeItems = 35;
force AGC_showBodyCount = false;

// ArmaForces - Mod
armaforces_ace_detonation_delay = 0.25;

// ArmaForces - Mod (Global)
armaforces_diagnostics_enable = true;
force armaforces_flag_attach_min_rank = 3;
force armaforces_insignia_group_min_rank = 2;
force armaforces_insignia_other_min_rank = 3;
force armaforces_main_rhs_engine_delay = true;
force armaforces_map_briefing_map = true;

// ArmaForces - No Actions
armaforces_no_action_setting_eject = true;
armaforces_no_action_setting_lightoff = false;
armaforces_no_action_setting_lighton = false;
armaforces_no_action_setting_rearm = false;
armaforces_no_action_setting_turnin = false;
armaforces_no_action_setting_turnout = false;
...
boxloader_preciseunload_enabled = false;

/********************************************************************************
  Nuke script logic:
  1. This script called by cfgcloudlets script via ammo ExplosionEffects
  2. This script then calls:  "nukedamage.sqs"; > sets damage on every entity
  3. nukedamage.sqs calls: "pook_scud\wep\nukeradzone.sqs"; > sets damage over time; sets rad effects
  4. nukeradzone.sqs expires after a few minutes.

 previous config:
 originally fired from cscript "trigger" script:
 Groundzero = "HeliHEmpty" createVehicle (position _base); // _base = MARKER ONMAPCLICK

********************************************************************************/


//*******************************************************************
//  NUKE LIGHT SOURCES, SMOKE CLOUD, ETC
//*******************************************************************
...
Groundzero = "Land_HelipadEmpty_F" createVehicle _nukePos;  // create heli empty marker for scripting purposes



if(player distance _nukePos < 2500) then {
	0 fadeSound 0;
	0 fadeRadio 0;
...
_top4 = "#particlesource" createVehicleLocal _nukePos;
...
_top5 = "#particlesource" createVehicleLocal _nukePos;
...
_smoke2 = "#particlesource" createVehicleLocal _nukePos;

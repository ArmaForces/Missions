...
[{
    ...
    [{!isNil "diwako_dui_nametags_RankNames"}, {
        ...
        [
            ...
            "82nd US Army Rangers", // TODO: Change this to apropriate unit based on player side/unit
            LLSTRING(TakistanRasmanAirfield) // TODO: Change this to apropriate location
        ] spawn FUNC(infoText);

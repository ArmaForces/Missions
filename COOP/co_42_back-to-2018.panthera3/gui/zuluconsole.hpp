...
class groupList_1: RscListbox
{
	...
	h = 0.33 * safezoneH;
	onLBSelChanged = "[lbCurSel 123] call fnc_groupsList";
};
...
{
	idc = 125;
	text = "Zmień nazwę"; //--- ToDo: Localize;
	x = 0.329436 * safezoneW + safezoneX;
	y = 0.668037 * safezoneH + safezoneY;
	w = 0.144324 * safezoneW;
	h = 0.0840187 * safezoneH;
	action = "(wgroups select (lbCurSel 123)) setGroupIdGlobal [ctrlText 124];[lbCurSel 123] call fnc_groupsList;";
